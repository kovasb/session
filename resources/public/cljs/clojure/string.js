...
{{
var G__14423 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14423;
continue;
}
} else
...
{var pred__14427 = cljs.core._EQ_;var expr__14428 = limit;if(cljs.core.truth_(pred__14427.call(null,1,expr__14428)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14427.call(null,2,expr__14428)))
...
var G__14430 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14431 = (limit__$1 - 1);
var G__14432 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14430;
limit__$1 = G__14431;
parts = G__14432;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14434 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14434))
{var replacement_14435 = temp__4090__auto___14434;buffer.append([cljs.core.str(replacement_14435)].join(''));
} else
{buffer.append(ch);
}
{
