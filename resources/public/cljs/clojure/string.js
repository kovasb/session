...
{{
var G__14816 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14816;
continue;
}
} else
...
{var pred__14820 = cljs.core._EQ_;var expr__14821 = limit;if(cljs.core.truth_(pred__14820.call(null,1,expr__14821)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14820.call(null,2,expr__14821)))
...
var G__14823 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14824 = (limit__$1 - 1);
var G__14825 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14823;
limit__$1 = G__14824;
parts = G__14825;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14827 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14827))
{var replacement_14828 = temp__4090__auto___14827;buffer.append([cljs.core.str(replacement_14828)].join(''));
} else
{buffer.append(ch);
}
{
var G__14829 = (index + 1);
index = G__14829;
continue;
}
}
