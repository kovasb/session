...
{{
var G__14820 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14820;
continue;
}
} else
...
{var pred__14824 = cljs.core._EQ_;var expr__14825 = limit;if(cljs.core.truth_(pred__14824.call(null,1,expr__14825)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14824.call(null,2,expr__14825)))
...
var G__14827 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14828 = (limit__$1 - 1);
var G__14829 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14827;
limit__$1 = G__14828;
parts = G__14829;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14831 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14831))
{var replacement_14832 = temp__4090__auto___14831;buffer.append([cljs.core.str(replacement_14832)].join(''));
} else
{buffer.append(ch);
}
{
var G__14833 = (index + 1);
index = G__14833;
continue;
}
}
