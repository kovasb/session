...
{{
var G__14821 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14821;
continue;
}
} else
...
{var pred__14825 = cljs.core._EQ_;var expr__14826 = limit;if(cljs.core.truth_(pred__14825.call(null,1,expr__14826)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14825.call(null,2,expr__14826)))
...
var G__14828 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14829 = (limit__$1 - 1);
var G__14830 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14828;
limit__$1 = G__14829;
parts = G__14830;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14832 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14832))
{var replacement_14833 = temp__4090__auto___14832;buffer.append([cljs.core.str(replacement_14833)].join(''));
} else
{buffer.append(ch);
}
{
var G__14834 = (index + 1);
index = G__14834;
continue;
}
}
