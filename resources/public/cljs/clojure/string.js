...
{{
var G__14592 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14592;
continue;
}
} else
...
{var pred__14596 = cljs.core._EQ_;var expr__14597 = limit;if(cljs.core.truth_(pred__14596.call(null,1,expr__14597)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14596.call(null,2,expr__14597)))
...
var G__14599 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14600 = (limit__$1 - 1);
var G__14601 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14599;
limit__$1 = G__14600;
parts = G__14601;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14603 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14603))
{var replacement_14604 = temp__4090__auto___14603;buffer.append([cljs.core.str(replacement_14604)].join(''));
} else
{buffer.append(ch);
}
{
var G__14605 = (index + 1);
index = G__14605;
continue;
}
}
