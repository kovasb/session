...
return (function (editor,event){if(cljs.core.truth_((function (){var and__3466__auto__ = event.shiftKey;if(cljs.core.truth_(and__3466__auto__))
...
, "keyMap": "subpar", "mode": "text/x-clojure", "lineNumbers": false, "matchBrackets": true});
});
