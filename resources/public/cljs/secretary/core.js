...
goog.require('clojure.string');
secretary.core.IRouteMatches = (function (){var obj14358 = {};return obj14358;
})();
...
secretary.core.IRouteValue = (function (){var obj14360 = {};return obj14360;
})();
secretary.core.route_value = (function route_value(this$){if((function (){var and__3391__auto__ = this$;if(and__3391__auto__)
...
{var x__4030__auto__ = (((this$ == null))?null:this$);return (function (){var or__3403__auto__ = (secretary.core.route_value[goog.typeOf(x__4030__auto__)]);if(or__3403__auto__)
{return or__3403__auto__;
} else
{var or__3403__auto____$1 = (secretary.core.route_value["_"]);if(or__3403__auto____$1)
{return or__3403__auto____$1;
} else
...
secretary.core.IRenderRoute = (function (){var obj14362 = {};return obj14362;
})();
...
*/
secretary.core.encode_pair = (function (){var method_table__4261__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prefer_table__4262__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var method_cache__4263__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var cached_hierarchy__4264__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var hierarchy__4265__auto__ = cljs.core.get.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",3129050535),cljs.core.get_global_hierarchy.call(null));return (new cljs.core.MultiFn("encode-pair",(function (p__14363){var vec__14364 = p__14363;var k = cljs.core.nth.call(null,vec__14364,0,null);var v = cljs.core.nth.call(null,vec__14364,1,null);if((cljs.core.sequential_QMARK_.call(null,v)) || (cljs.core.set_QMARK_.call(null,v)))
{return new cljs.core.Keyword("secretary.core","sequential","secretary.core/sequential",1410725665);
} else
{if((function (){var or__3403__auto__ = cljs.core.map_QMARK_.call(null,v);if(or__3403__auto__)
{return or__3403__auto__;
} else
{var G__14366 = v;if(G__14366)
{var bit__4053__auto__ = (G__14366.cljs$lang$protocol_mask$partition0$ & 67108864);if((bit__4053__auto__) || (G__14366.cljs$core$IRecord$))
{return true;
} else
{if((!G__14366.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IRecord,G__14366);
} else
{return false;
}
}
...
;
cljs.core._add_method.call(null,secretary.core.encode_pair,new cljs.core.Keyword("secretary.core","sequential","secretary.core/sequential",1410725665),(function (p__14367){var vec__14368 = p__14367;var k = cljs.core.nth.call(null,vec__14368,0,null);var v = cljs.core.nth.call(null,vec__14368,1,null);var encoded = cljs.core.map_indexed.call(null,(function (i,x){var pair = ((cljs.core.coll_QMARK_.call(null,x))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [secretary.core.key_index.call(null,k,i),x], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [secretary.core.key_index.call(null,k),x], null));return secretary.core.encode_pair.call(null,pair);
}),v);return clojure.string.join.call(null,"&",encoded);
}));
cljs.core._add_method.call(null,secretary.core.encode_pair,new cljs.core.Keyword("secretary.core","map","secretary.core/map",572371848),(function (p__14369){var vec__14370 = p__14369;var k = cljs.core.nth.call(null,vec__14370,0,null);var v = cljs.core.nth.call(null,vec__14370,1,null);var encoded = cljs.core.map.call(null,(function (p__14371){var vec__14372 = p__14371;var ik = cljs.core.nth.call(null,vec__14372,0,null);var iv = cljs.core.nth.call(null,vec__14372,1,null);return secretary.core.encode_pair.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [secretary.core.key_index.call(null,k,cljs.core.name.call(null,ik)),iv], null));
}),v);return clojure.string.join.call(null,"&",encoded);
}));
cljs.core._add_method.call(null,secretary.core.encode_pair,new cljs.core.Keyword(null,"default","default",2558708147),(function (p__14373){var vec__14374 = p__14373;var k = cljs.core.nth.call(null,vec__14374,0,null);var v = cljs.core.nth.call(null,vec__14374,1,null);return [cljs.core.str(cljs.core.name.call(null,k)),cljs.core.str("="),cljs.core.str(secretary.core.encode.call(null,[cljs.core.str(v)].join('')))].join('');
}));
/**
...
*/
secretary.core.parse_path = (function parse_path(path){var index_re = /\[([^\]]*)\]*/;var parts = cljs.core.re_seq.call(null,index_re,path);return cljs.core.map.call(null,(function (p__14377){var vec__14378 = p__14377;var _ = cljs.core.nth.call(null,vec__14378,0,null);var part = cljs.core.nth.call(null,vec__14378,1,null);if(cljs.core.empty_QMARK_.call(null,part))
{return 0;
} else
...
* 
*/
secretary.core.key_parse = (function key_parse(k){var re = /([^\[\]]+)((?:\[[^\]]*\])*)?/;var vec__14380 = cljs.core.re_matches.call(null,re,k);var _ = cljs.core.nth.call(null,vec__14380,0,null);var key = cljs.core.nth.call(null,vec__14380,1,null);var path = cljs.core.nth.call(null,vec__14380,2,null);var parsed_path = (cljs.core.truth_(path)?secretary.core.parse_path.call(null,path):null);return cljs.core.cons.call(null,key,parsed_path);
});
/**
...
return (function (m,part){var vec__14382 = clojure.string.split.call(null,part,/=/,2);var k = cljs.core.nth.call(null,vec__14382,0,null);var v = cljs.core.nth.call(null,vec__14382,1,null);return secretary.core.assoc_in_query_params.call(null,m,secretary.core.key_parse.call(null,k),secretary.core.decode.call(null,v));
});})(parts))
...
*/
secretary.core.lex_STAR_ = (function lex_STAR_(s,clauses){return cljs.core.some.call(null,(function (p__14386){var vec__14387 = p__14386;var re = cljs.core.nth.call(null,vec__14387,0,null);var action = cljs.core.nth.call(null,vec__14387,1,null);var temp__4092__auto__ = cljs.core.re_find.call(null,re,s);if(cljs.core.truth_(temp__4092__auto__))
{var vec__14388 = temp__4092__auto__;var m = cljs.core.nth.call(null,vec__14388,0,null);var c = cljs.core.nth.call(null,vec__14388,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,s,cljs.core.count.call(null,m)),action.call(null,c)], null);
} else
{return null;
}
}),clauses);
...
{var vec__14391 = secretary.core.lex_STAR_.call(null,s__$1,clauses);var s__$2 = cljs.core.nth.call(null,vec__14391,0,null);var vec__14392 = cljs.core.nth.call(null,vec__14391,1,null);var r = cljs.core.nth.call(null,vec__14392,0,null);var p = cljs.core.nth.call(null,vec__14392,1,null);{
var G__14393 = s__$2;
var G__14394 = [cljs.core.str(pattern),cljs.core.str(r)].join('');
var G__14395 = cljs.core.conj.call(null,params,p);
s__$1 = G__14393;
pattern = G__14394;
params = G__14395;
continue;
...
})], null)], null);var vec__14401 = secretary.core.lex_route.call(null,orig_route,clauses);var re = cljs.core.nth.call(null,vec__14401,0,null);var params = cljs.core.nth.call(null,vec__14401,1,null);if(typeof secretary.core.t14402 !== 'undefined')
{} else
{
/**
* @constructor
*/
secretary.core.t14402 = (function (params,re,vec__14401,clauses,orig_route,compile_route,meta14403){
this.params = params;
this.re = re;
this.vec__14401 = vec__14401;
...
secretary.core.t14402.cljs$lang$type = true;
secretary.core.t14402.cljs$lang$ctorStr = "secretary.core/t14402";
secretary.core.t14402.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"secretary.core/t14402");
});
secretary.core.t14402.prototype.secretary$core$IRouteMatches$ = true;
secretary.core.t14402.prototype.secretary$core$IRouteMatches$route_matches$arity$2 = (function (_,route){var self__ = this;
...
{var vec__14405 = temp__4092__auto__;var ___$2 = cljs.core.nth.call(null,vec__14405,0,null);var ms = cljs.core.nthnext.call(null,vec__14405,1);return cljs.core.merge_with.call(null,cljs.core.vector,cljs.core.PersistentArrayMap.EMPTY,cljs.core.partition.call(null,2,cljs.core.interleave.call(null,self__.params,cljs.core.map.call(null,secretary.core.decode,ms))));
} else
{return null;
}
});
secretary.core.t14402.prototype.secretary$core$IRouteValue$ = true;
secretary.core.t14402.prototype.secretary$core$IRouteValue$route_value$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;return self__.orig_route;
});
secretary.core.t14402.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14404){var self__ = this;
var _14404__$1 = this;return self__.meta14403;
});
secretary.core.t14402.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14404,meta14403__$1){var self__ = this;
var _14404__$1 = this;return (new secretary.core.t14402(self__.params,self__.re,self__.vec__14401,self__.clauses,self__.orig_route,self__.compile_route,meta14403__$1));
});
secretary.core.__GT_t14402 = (function __GT_t14402(params__$1,re__$1,vec__14401__$1,clauses__$1,orig_route__$1,compile_route__$1,meta14403){return (new secretary.core.t14402(params__$1,re__$1,vec__14401__$1,clauses__$1,orig_route__$1,compile_route__$1,meta14403));
});
}
return (new secretary.core.t14402(params,re,vec__14401,clauses,orig_route,compile_route,null));
});
/**
* @param {...*} var_args
*/
secretary.core.render_route_STAR_ = (function() { 
var render_route_STAR___delegate = function (obj,args){if((function (){var G__14407 = obj;if(G__14407)
...
{return G__14407.secretary$core$IRenderRoute$;
}
})()))
{return true;
} else
{if((!G__14407.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,secretary.core.IRenderRoute,G__14407);
} else
{return false;
}
}
...
render_route_STAR_.cljs$lang$applyTo = (function (arglist__14408){
var obj = cljs.core.first(arglist__14408);
...
secretary.core.remove_route_BANG_ = (function remove_route_BANG_(obj){return cljs.core.swap_BANG_.call(null,secretary.core._STAR_routes_STAR_,(function (rs){return cljs.core.filterv.call(null,(function (p__14411){var vec__14412 = p__14411;var x = cljs.core.nth.call(null,vec__14412,0,null);var _ = cljs.core.nth.call(null,vec__14412,1,null);return cljs.core.not_EQ_.call(null,x,obj);
}),rs);
}));
});
...
secretary.core.locate_route = (function locate_route(route){return cljs.core.some.call(null,(function (p__14415){var vec__14416 = p__14415;var compiled_route = cljs.core.nth.call(null,vec__14416,0,null);var action = cljs.core.nth.call(null,vec__14416,1,null);var temp__4092__auto__ = secretary.core.route_matches.call(null,compiled_route,route);if(cljs.core.truth_(temp__4092__auto__))
...
*/
secretary.core.dispatch_BANG_ = (function dispatch_BANG_(uri){var vec__14419 = clojure.string.split.call(null,uri,/\?/);var uri_path = cljs.core.nth.call(null,vec__14419,0,null);var query_string = cljs.core.nth.call(null,vec__14419,1,null);var query_params = (cljs.core.truth_(query_string)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"query-params","query-params",1080249757),secretary.core.decode_query_params.call(null,query_string)], null):null);var map__14420 = secretary.core.locate_route.call(null,uri_path);var map__14420__$1 = ((cljs.core.seq_QMARK_.call(null,map__14420))?cljs.core.apply.call(null,cljs.core.hash_map,map__14420):map__14420);var params = cljs.core.get.call(null,map__14420__$1,new cljs.core.Keyword(null,"params","params",4313443576));var action = cljs.core.get.call(null,map__14420__$1,new cljs.core.Keyword(null,"action","action",3885920680));var action__$1 = (function (){var or__3403__auto__ = action;if(cljs.core.truth_(or__3403__auto__))
{return or__3403__auto__;
} else
...
{var vec__14421 = temp__4092__auto__;var _ = cljs.core.nth.call(null,vec__14421,0,null);var ms = cljs.core.nthnext.call(null,vec__14421,1);return cljs.core.vec.call(null,ms);
} else
{return null;
}
});
...
(secretary.core.render_route["string"] = (function (this$,params){var map__14422 = params;var map__14422__$1 = ((cljs.core.seq_QMARK_.call(null,map__14422))?cljs.core.apply.call(null,cljs.core.hash_map,map__14422):map__14422);var m = map__14422__$1;var query_params = cljs.core.get.call(null,map__14422__$1,new cljs.core.Keyword(null,"query-params","query-params",1080249757));var a = cljs.core.atom.call(null,m);var path = this$.replace((new RegExp(":[^\\s.:*/]+|\\*[^\\s.:*/]*","g")),((function (map__14422,map__14422__$1,m,query_params,a){
...
});})(map__14422,map__14422__$1,m,query_params,a))
