...
var this__7136 = this;
if(cljs.core._EQ_.call(null,"\uFDD0'this",this__7136.model))
{return cljs_jquery.core.jquery.call(null,this);
} else
{if((function (){var or__3824__auto____7137 = cljs.core.vector_QMARK_.call(null,this__7136.model);
if(or__3824__auto____7137)
{return or__3824__auto____7137;
} else
{return cljs.core.keyword_QMARK_.call(null,this__7136.model);
}
})())
{return cljs_jquery.core.dom_create.call(null,this__7136.model);
} else
{if(true)
{return cljs_jquery.core.jquery.call(null,this__7136.model);
} else
{return null;
}
}
...
var this__7139 = this;
return cljs.core.concat.call(null,cljs.core.PersistentVector.fromArray(["#hiccup "], true),cljs.core._pr_seq.call(null,this__7139.model,opts),"");
});
