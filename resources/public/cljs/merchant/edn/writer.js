...
goog.require('goog.string');
merchant.edn.writer.char_escapes = (function (){var obj14639 = {"\"":"\\\"","\\":"\\\\","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t"};return obj14639;
})();
...
var temp__4092__auto___14648 = cljs.core.seq.call(null,sequence);if(temp__4092__auto___14648)
{var xs_14649 = temp__4092__auto___14648;var G__14645_14650 = xs_14649;var vec__14646_14651 = G__14645_14650;var x_14652 = cljs.core.nth.call(null,vec__14646_14651,0,null);var xs_14653__$1 = cljs.core.nthnext.call(null,vec__14646_14651,1);var G__14645_14654__$1 = G__14645_14650;while(true){
var vec__14647_14655 = G__14645_14654__$1;var x_14656__$1 = cljs.core.nth.call(null,vec__14647_14655,0,null);var xs_14657__$2 = cljs.core.nthnext.call(null,vec__14647_14655,1);print_one.call(null,x_14656__$1);
if(xs_14657__$2)
{w.append(sep);
{
var G__14658 = xs_14657__$2;
G__14645_14654__$1 = G__14658;
continue;
}
} else
{}
...
merchant.edn.writer.EdnWriter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4066__auto__,k14663,else__4067__auto__){var self__ = this;
var this__4066__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k14663,new cljs.core.Keyword(null,"w","w",1013904361)))
{return self__.w;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k14663,new cljs.core.Keyword(null,"wm","wm",1013908040)))
{return self__.wm;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k14663,else__4067__auto__);
} else
{return null;
}
}
...
merchant.edn.writer.EdnWriter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4071__auto__,k__4072__auto__,G__14662){var self__ = this;
var this__4071__auto____$1 = this;var pred__14665 = cljs.core.keyword_identical_QMARK_;var expr__14666 = k__4072__auto__;if(cljs.core.truth_(pred__14665.call(null,new cljs.core.Keyword(null,"w","w",1013904361),expr__14666)))
{return (new merchant.edn.writer.EdnWriter(G__14662,self__.wm,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__14665.call(null,new cljs.core.Keyword(null,"wm","wm",1013908040),expr__14666)))
{return (new merchant.edn.writer.EdnWriter(self__.w,G__14662,self__.__meta,self__.__extmap,null));
} else
{return (new merchant.edn.writer.EdnWriter(self__.w,self__.wm,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4072__auto__,G__14662),null));
}
}
});
...
return (function (p1__14659_SHARP_){return merchant.common.write.call(null,this$__$1,p1__14659_SHARP_);
});})(this$__$1))
," ",")",o,self__.w);
});
...
var this$__$1 = this;return merchant.edn.writer.write_sequential.call(null,"#{",((function (this$__$1){
return (function (p1__14661_SHARP_){return merchant.common.write.call(null,this$__$1,p1__14661_SHARP_);
});})(this$__$1))
," ","}",o,self__.w);
});
...
var this$__$1 = this;return merchant.edn.writer.write_sequential.call(null,"[",((function (this$__$1){
return (function (p1__14660_SHARP_){return merchant.common.write.call(null,this$__$1,p1__14660_SHARP_);
});})(this$__$1))
," ","]",o,self__.w);
});
...
merchant.edn.writer.EdnWriter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4063__auto__,G__14662){var self__ = this;
var this__4063__auto____$1 = this;return (new merchant.edn.writer.EdnWriter(self__.w,self__.wm,G__14662,self__.__extmap,self__.__hash));
});
...
merchant.edn.writer.map__GT_EdnWriter = (function map__GT_EdnWriter(G__14664){return (new merchant.edn.writer.EdnWriter(new cljs.core.Keyword(null,"w","w",1013904361).cljs$core$IFn$_invoke$arity$1(G__14664),new cljs.core.Keyword(null,"wm","wm",1013908040).cljs$core$IFn$_invoke$arity$1(G__14664),null,cljs.core.dissoc.call(null,G__14664,new cljs.core.Keyword(null,"w","w",1013904361),new cljs.core.Keyword(null,"wm","wm",1013908040))));
});
merchant.edn.writer.type_dispatch_map = (function type_dispatch_map(type_map,dispatch_map){return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__14670){var vec__14671 = p__14670;var k = cljs.core.nth.call(null,vec__14671,0,null);var v = cljs.core.nth.call(null,vec__14671,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,dispatch_map.call(null,v)], null);
}),type_map));
});
...
merchant.edn.writer.edn_writer = (function edn_writer(jwriter,opts){var map__14673 = opts;var map__14673__$1 = ((cljs.core.seq_QMARK_.call(null,map__14673))?cljs.core.apply.call(null,cljs.core.hash_map,map__14673):map__14673);var default_fn = cljs.core.get.call(null,map__14673__$1,new cljs.core.Keyword(null,"default-fn","default-fn",1692507974),((function (map__14673,map__14673__$1){
return (function (this$,o){throw (new Error("No EDN mapping for type"));
});})(map__14673,map__14673__$1))
);var tag_map = cljs.core.get.call(null,map__14673__$1,new cljs.core.Keyword(null,"tag-map","tag-map",3758714907));var type_map = cljs.core.get.call(null,map__14673__$1,new cljs.core.Keyword(null,"type-map","type-map",4631392187));return (new merchant.edn.writer.EdnWriter(jwriter,merchant.edn.writer.make_writer_fn.call(null,merchant.edn.writer.type_dispatch_map.call(null,cljs.core.merge.call(null,merchant.common.default_type_map,type_map),merchant.common.default_dispatch_map),cljs.core.merge.call(null,merchant.common.default_tag_map,tag_map),default_fn)));
});
