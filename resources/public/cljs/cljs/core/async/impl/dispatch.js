...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14173 = 0;while(true){
var m_14174 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14174 == null))
{} else
{m_14174.call(null);
if((count_14173 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14175 = (count_14173 + 1);
count_14173 = G__14175;
continue;
}
} else
{}
