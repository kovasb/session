...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14566 = 0;while(true){
var m_14567 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14567 == null))
{} else
{m_14567.call(null);
if((count_14566 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14568 = (count_14566 + 1);
count_14566 = G__14568;
continue;
}
} else
{}
