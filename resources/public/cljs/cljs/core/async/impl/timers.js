...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14138 = 0;while(true){
if((i_14138 < arr.length))
{(arr[i_14138] = null);
{
...
{var i_14145 = (self__.level + 1);while(true){
if((i_14145 <= (new_level + 1)))
{(update[i_14145] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14147 = 0;while(true){
if((i_14147 <= self__.level))
{var links_14148 = (update[i_14147]).forward;if(((links_14148[i_14147]) === x__$1))
{(links_14148[i_14147] = (x__$1.forward[i_14147]));
{
