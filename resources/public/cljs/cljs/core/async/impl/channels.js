...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14179 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14179 = (function (val,box,meta14180){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14179.cljs$lang$type = true;
cljs.core.async.impl.channels.t14179.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14179";
cljs.core.async.impl.channels.t14179.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t14179");
});
cljs.core.async.impl.channels.t14179.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14179.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14181){var self__ = this;
var _14181__$1 = this;return self__.meta14180;
});
cljs.core.async.impl.channels.t14179.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14181,meta14180__$1){var self__ = this;
var _14181__$1 = this;return (new cljs.core.async.impl.channels.t14179(self__.val,self__.box,meta14180__$1));
});
cljs.core.async.impl.channels.__GT_t14179 = (function __GT_t14179(val__$1,box__$1,meta14180){return (new cljs.core.async.impl.channels.t14179(val__$1,box__$1,meta14180));
});
}
return (new cljs.core.async.impl.channels.t14179(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14182 = self__.takes.pop();if((taker_14182 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14182))
{var take_cb_14183 = cljs.core.async.impl.protocols.commit.call(null,taker_14182);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14183,taker_14182){
return (function (){return take_cb_14183.call(null,null);
});})(take_cb_14183,taker_14182))
);
} else
{}
{
