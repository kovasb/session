...
cljs.core._invoke = function() {
  var a = null;
  return function(a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s, t, u, la) {
    switch(arguments.length) {
      ...
      case 16:
        ...
        if(cljs.core.truth_(cljs.core.truth_(a) ? a.cljs$core$IFn$_invoke : a)) {
          ...
          Z = aa.call(null, a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p)
        }
        return Z;
      case 17:
        var ba;
        if(cljs.core.truth_(cljs.core.truth_(a) ? a.cljs$core$IFn$_invoke : a)) {
          ba = a.cljs$core$IFn$_invoke(a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r)
        }else {
          var ca;
          var Sa = cljs.core._invoke[goog.typeOf.call(null, a)];
          if(cljs.core.truth_(Sa)) {
          ...
          ba = ca.call(null, a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r)
        }
        return ba;
      case 18:
        var da;
        if(cljs.core.truth_(cljs.core.truth_(a) ? a.cljs$core$IFn$_invoke : a)) {
          da = a.cljs$core$IFn$_invoke(a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s)
        }else {
          var ea;
          var Ua = cljs.core._invoke[goog.typeOf.call(null, a)];
          if(cljs.core.truth_(Ua)) {
          ...
          da = ea.call(null, a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s)
        }
        return da;
      case 19:
        var fa;
        if(cljs.core.truth_(cljs.core.truth_(a) ? a.cljs$core$IFn$_invoke : a)) {
          fa = a.cljs$core$IFn$_invoke(a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s, t)
        }else {
          var ga;
          var Wa = cljs.core._invoke[goog.typeOf.call(null, a)];
          if(cljs.core.truth_(Wa)) {
          ...
          fa = ga.call(null, a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s, t)
        }
        return fa;
      case 20:
        var ha;
        if(cljs.core.truth_(cljs.core.truth_(a) ? a.cljs$core$IFn$_invoke : a)) {
          ha = a.cljs$core$IFn$_invoke(a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s, t, u)
        }else {
          var ia;
          var Ya = cljs.core._invoke[goog.typeOf.call(null, a)];
          if(cljs.core.truth_(Ya)) {
          ...
          ha = ia.call(null, a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s, t, u)
        }
        return ha;
      case 21:
        var ja;
        if(cljs.core.truth_(cljs.core.truth_(a) ? a.cljs$core$IFn$_invoke : a)) {
          ja = a.cljs$core$IFn$_invoke(a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s, t, u, la)
        }else {
          var ka;
          ...
          ja = ka.call(null, a, c, d, e, f, g, h, i, j, k, m, l, o, n, q, p, r, s, t, u, la)
        }
        return ja
    }
...
session.client.mvc.view = function(a) {
  if(cljs.core.truth_(cljs.core.truth_(a) ? a.session$client$mvc$IMVC$view : a)) {
    a = a.session$client$mvc$IMVC$view(a)
  }else {
    var b;
    b = session.client.mvc.view[goog.typeOf.call(null, a)];
    if(!cljs.core.truth_(b) && (b = session.client.mvc.view._, !cljs.core.truth_(b))) {
...
session.client.mvc.control = function(a, b) {
  var c;
  if(cljs.core.truth_(cljs.core.truth_(a) ? a.session$client$mvc$IMVC$control : a)) {
    c = a.session$client$mvc$IMVC$control(a, b)
  }else {
    c = session.client.mvc.control[goog.typeOf.call(null, a)];
    if(!cljs.core.truth_(c) && (c = session.client.mvc.control._, !cljs.core.truth_(c))) {
...
session.client.mvc.control2 = function() {
  ...
  return new cljs.core.MultiFn("control2", function(a) {
    return cljs.core.identity.call(null, "\ufdd0'view".call(null, cljs.core.meta.call(null, a)))
  }, "\ufdd0'default", e, a, b, c, d)
}();
...
cljs.core._add_method.call(null, session.client.mvc.view2, "\ufdd0'dom", function(a) {
  return cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", a)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
...
session.client.mvc.render = function(a) {
  ...
  session.client.mvc.control.call(null, a, b);
  return b
};
session.client.editor = {};
session.client.editor.jsObj = function jsObj(b) {
...
session.client.editor.add_keybindings = function() {
  return session.client.editor.canon.addCommand(session.client.editor.jsObj.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'bindKey", "\ufdd0'exec"], {"\ufdd0'name":"evaluateCell", "\ufdd0'bindKey":cljs.core.ObjMap.fromObject(["\ufdd0'win", "\ufdd0'mac", "\ufdd0'sender"], {"\ufdd0'win":"Shift-Return", "\ufdd0'mac":"Shift-Return", "\ufdd0'sender":"editor"}), "\ufdd0'exec":function(a, b, c) {
    session.client.editor.keyevent = cljs.core.PersistentVector.fromArray([a, b, c]);
    return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", a.editor.container)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var b = cljs.core.vector_QMARK_.call(null, a.editor.container);
      return cljs.core.truth_(b) ? b : cljs.core.keyword_QMARK_.call(null, a.editor.container)
    }()) ? cljs_jquery.core.dom_create.call(null, a.editor.container) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, a.editor.container) : null, cljs.core.PersistentVector.fromArray(["trigger", "evaluate-input"]))
  }})))
};
session.client.editor.fit_to_length_function = function(a, b) {
  return function() {
    var c = cljs.core.str.call(null, b.renderer.lineHeight * b.getSession().getLength(), "px");
    cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.str.call(null, "#", a))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var b = cljs.core.vector_QMARK_.call(null, cljs.core.str.call(null, "#", a));
      return cljs.core.truth_(b) ? b : cljs.core.keyword_QMARK_.call(null, cljs.core.str.call(null, "#", a))
    }()) ? cljs_jquery.core.dom_create.call(null, cljs.core.str.call(null, "#", a)) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, cljs.core.str.call(null, "#", a)) : null, cljs.core.PersistentVector.fromArray(["css", "height", c]));
    return b.resize()
  }
};
session.client.editor.fit_to_length = function(a, b) {
  var c = cljs.core.str.call(null, b.renderer.lineHeight * b.getSession().getLength(), "px");
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.str.call(null, "#", a))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var b = cljs.core.vector_QMARK_.call(null, cljs.core.str.call(null, "#", a));
    return cljs.core.truth_(b) ? b : cljs.core.keyword_QMARK_.call(null, cljs.core.str.call(null, "#", a))
...
session.client.loop = {};
session.client.loop.Loop = function(a) {
  this.model = a
};
session.client.loop.Loop.cljs$core$IPrintable$_pr_seq = function() {
  return cljs.core.list.call(null, "session.client.loop.Loop")
};
session.client.loop.Loop.prototype.session$client$mvc$IMVC$ = !0;
session.client.loop.Loop.prototype.session$client$mvc$IMVC$view = function(a) {
  var b = "\ufdd0'id".call(null, a);
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.PersistentVector.fromArray(["\ufdd0'div.loop-container", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row.input", cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":b}), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-chevron-right", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"float:left"}), 
  ""]), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span5", cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'style"], {"\ufdd0'id":cljs.core.str.call(null, "area", b), "\ufdd0'style":"margin-left:0px;position:relative;height:18px"}), cljs.core.deref.call(null, "\ufdd0'input".call(null, a))]), cljs.core.PersistentVector.fromArray(["\ufdd0'a.close.loop-deleter", cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'id", "\ufdd0'style"], {"\ufdd0'href":"#", "\ufdd0'id":cljs.core.str.call(null, 
  "delete", b), "\ufdd0'style":"margin-left:10px;float:none"}), "x"])])]), cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":cljs.core.str.call(null, "out", b)}), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-chevron-left", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"float:left"}), ""]), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span5.loopout", 
  cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"margin-left:0px;position:relative"}), session.client.mvc.view2.call(null, cljs.core.deref.call(null, "\ufdd0'output".call(null, a)))])])]), function() {
    var a = session.client.mvc.view2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})));
    cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", a)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var b = cljs.core.vector_QMARK_.call(null, a);
      return cljs.core.truth_(b) ? b : cljs.core.keyword_QMARK_.call(null, a)
    }()) ? cljs_jquery.core.dom_create.call(null, a) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, a) : null, cljs.core.PersistentVector.fromArray(["on", "mouseover", function() {
      return cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "\ufdd0'this")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
        var a = cljs.core.vector_QMARK_.call(null, "\ufdd0'this");
        return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "\ufdd0'this")
      }()) ? cljs_jquery.core.dom_create.call(null, "\ufdd0'this") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "\ufdd0'this") : null, cljs.core.PersistentVector.fromArray(["find", ".new-loop-icon"])), cljs.core.PersistentVector.fromArray(["toggleClass", "icon-chevron-right"]))
    }]));
    cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", a)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var b = cljs.core.vector_QMARK_.call(null, a);
      return cljs.core.truth_(b) ? b : cljs.core.keyword_QMARK_.call(null, a)
    }()) ? cljs_jquery.core.dom_create.call(null, a) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, a) : null, cljs.core.PersistentVector.fromArray(["on", "mouseout", function() {
      return cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "\ufdd0'this")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
        var a = cljs.core.vector_QMARK_.call(null, "\ufdd0'this");
        return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "\ufdd0'this")
      }()) ? cljs_jquery.core.dom_create.call(null, "\ufdd0'this") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "\ufdd0'this") : null, cljs.core.PersistentVector.fromArray(["find", ".new-loop-icon"])), cljs.core.PersistentVector.fromArray(["toggleClass", "icon-chevron-right"]))
    ...
    return a
  }()]))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    ...
    cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'style"], {"\ufdd0'id":cljs.core.str.call(null, "area", b), "\ufdd0'style":"margin-left:0px;position:relative;height:18px"}), cljs.core.deref.call(null, "\ufdd0'input".call(null, a))]), cljs.core.PersistentVector.fromArray(["\ufdd0'a.close.loop-deleter", cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'id", "\ufdd0'style"], {"\ufdd0'href":"#", "\ufdd0'id":cljs.core.str.call(null, "delete", b), "\ufdd0'style":"margin-left:10px;float:none"}), 
    ...
    session.client.mvc.view2.call(null, cljs.core.deref.call(null, "\ufdd0'output".call(null, a)))])])]), function() {
      var a = session.client.mvc.view2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})));
      cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", a)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
        var b = cljs.core.vector_QMARK_.call(null, a);
        return cljs.core.truth_(b) ? b : cljs.core.keyword_QMARK_.call(null, a)
    ...
    return cljs.core.truth_(c) ? c : cljs.core.keyword_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.loop-container", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row.input", cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":b}), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-chevron-right", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"float:left"}), ""]), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span5", 
    cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'style"], {"\ufdd0'id":cljs.core.str.call(null, "area", b), "\ufdd0'style":"margin-left:0px;position:relative;height:18px"}), cljs.core.deref.call(null, "\ufdd0'input".call(null, a))]), cljs.core.PersistentVector.fromArray(["\ufdd0'a.close.loop-deleter", cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'id", "\ufdd0'style"], {"\ufdd0'href":"#", "\ufdd0'id":cljs.core.str.call(null, "delete", b), "\ufdd0'style":"margin-left:10px;float:none"}), 
    "x"])])]), cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":cljs.core.str.call(null, "out", b)}), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-chevron-left", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"float:left"}), ""]), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span5.loopout", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"margin-left:0px;position:relative"}), 
    session.client.mvc.view2.call(null, cljs.core.deref.call(null, "\ufdd0'output".call(null, a)))])])]), function() {
      var a = session.client.mvc.view2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})));
  ...
  session.client.mvc.view2.call(null, cljs.core.deref.call(null, "\ufdd0'output".call(null, a)))])])]), function() {
    ...
    return a
  }()])) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.loop-container", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row.input", cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":b}), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-chevron-right", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"float:left"}), ""]), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span5", 
  cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'style"], {"\ufdd0'id":cljs.core.str.call(null, "area", b), "\ufdd0'style":"margin-left:0px;position:relative;height:18px"}), cljs.core.deref.call(null, "\ufdd0'input".call(null, a))]), cljs.core.PersistentVector.fromArray(["\ufdd0'a.close.loop-deleter", cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'id", "\ufdd0'style"], {"\ufdd0'href":"#", "\ufdd0'id":cljs.core.str.call(null, "delete", b), "\ufdd0'style":"margin-left:10px;float:none"}), "x"])])]), 
  cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.ObjMap.fromObject(["\ufdd0'id"], {"\ufdd0'id":cljs.core.str.call(null, "out", b)}), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-chevron-left", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"float:left"}), ""]), cljs.core.PersistentVector.fromArray(["\ufdd0'div.span5.loopout", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"margin-left:0px;position:relative"}), 
  session.client.mvc.view2.call(null, cljs.core.deref.call(null, "\ufdd0'output".call(null, a)))])])]), function() {
    var a = session.client.mvc.view2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})));
    ...
    return a
  }()])) : null, cljs.core.PersistentVector.fromArray(["data", "model", a]))
};
session.client.loop.Loop.prototype.session$client$mvc$IMVC$control = function(a, b) {
  var c = cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["data", "model"])), d = "\ufdd0'id".call(null, c), e = cljs.core.atom.call(null, cljs.core.PersistentVector.fromArray([]));
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "click", ".loop-creator", function() {
    return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, b);
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
    }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["trigger", "insert-new-loop"]))
  }]));
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "post-render", function() {
    cljs.core.reset_BANG_.call(null, e, session.client.editor.create_editor.call(null, cljs.core.str.call(null, "area", d)));
    return session.client.editor.fit_to_length.call(null, cljs.core.str.call(null, "area", d), cljs.core.deref.call(null, e))
  }]));
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "click", ".loop-deleter", function() {
    return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, b);
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
    }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["trigger", "delete-loop"]))
  }]));
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "evaluate-input", function() {
    cljs.core.reset_BANG_.call(null, "\ufdd0'input".call(null, c), cljs.core.deref.call(null, e).getSession().getValue());
    return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, b);
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
    }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["trigger", "evaluate-loop"]))
  }]));
  return cljs.core.add_watch.call(null, "\ufdd0'output".call(null, c), "\ufdd0'update-output", function(a, c, d, e) {
    return cljs.core.truth_(cljs.core._EQ_.call(null, cljs.core.Atom, cljs.core.type.call(null, e))) ? (alert.call(null, "add atom to watch"), cljs.core.add_watch.call(null, e, "\ufdd0'update-from-atom", function(a, c, d, e) {
      alert.call(null, "atom update");
      return cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
        var a = cljs.core.vector_QMARK_.call(null, b);
        return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
      }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["find", ".loopout"])), cljs.core.PersistentVector.fromArray(["html", ""])), cljs.core.PersistentVector.fromArray(["append", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, e)]))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
        var a = cljs.core.vector_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, e)]));
        return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, e)]))
      }()) ? cljs_jquery.core.dom_create.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, e)])) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, e)])) : null]))
    }), cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, b);
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
    }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["find", ".loopout"])), cljs.core.PersistentVector.fromArray(["html", ""])), cljs.core.PersistentVector.fromArray(["append", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, cljs.core.deref.call(null, e))]))) ? cljs_jquery.core.jquery.call(null, 
    this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, cljs.core.deref.call(null, e))]));
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, cljs.core.deref.call(null, e))]))
    }()) ? cljs_jquery.core.dom_create.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, cljs.core.deref.call(null, e))])) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, cljs.core.deref.call(null, e))])) : null]))) : cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, 
    "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, b);
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
    }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["find", ".loopout"])), cljs.core.PersistentVector.fromArray(["html", ""])), cljs.core.PersistentVector.fromArray(["append", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, e)]))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", session.client.mvc.view2.call(null, e)]));
...
session.client.loop.Loop.prototype.cljs$core$ILookup$ = !0;
session.client.loop.Loop.prototype.cljs$core$ILookup$_lookup = function() {
  var a = null;
  return function(a, c, d) {
    switch(arguments.length) {
      case 2:
        return this.model.call(null, c);
      case 3:
        return this.model.call(null, c, d)
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
session.client.loop.Loop.prototype.cljs$core$IPrintable$ = !0;
session.client.loop.Loop.prototype.cljs$core$IPrintable$_pr_seq = function(a, b) {
  return cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray(["#session/loop "]), cljs.core._pr_seq.call(null, cljs.core.assoc.call(null, this.model, "\ufdd0'input", cljs.core.deref.call(null, "\ufdd0'input".call(null, this.model)), "\ufdd0'output", cljs.core.deref.call(null, "\ufdd0'output".call(null, this.model))), b), "")
};
session.client.loop_creator = {};
cljs.core._add_method.call(null, session.client.mvc.view2, "\ufdd0'loop-creator", function(a) {
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row.span6.loop-creator", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"margin-left:0px;height:18px"}), cljs.core.PersistentVector.fromArray(["\ufdd0'i.new-loop-icon", ""])]))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.row.span6.loop-creator", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"margin-left:0px;height:18px"}), cljs.core.PersistentVector.fromArray(["\ufdd0'i.new-loop-icon", ""])]));
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.row.span6.loop-creator", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"margin-left:0px;height:18px"}), cljs.core.PersistentVector.fromArray(["\ufdd0'i.new-loop-icon", ""])]))
  }()) ? cljs_jquery.core.dom_create.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.row.span6.loop-creator", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"margin-left:0px;height:18px"}), cljs.core.PersistentVector.fromArray(["\ufdd0'i.new-loop-icon", ""])])) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.row.span6.loop-creator", cljs.core.ObjMap.fromObject(["\ufdd0'style"], {"\ufdd0'style":"margin-left:0px;height:18px"}), 
  cljs.core.PersistentVector.fromArray(["\ufdd0'i.new-loop-icon", ""])])) : null, cljs.core.PersistentVector.fromArray(["data", "model", a]))
});
cljs.core._add_method.call(null, session.client.mvc.control2, "\ufdd0'loop-creator", function(a, b) {
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "click", function() {
    return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "\ufdd0'this")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, "\ufdd0'this");
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "\ufdd0'this")
    }()) ? cljs_jquery.core.dom_create.call(null, "\ufdd0'this") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "\ufdd0'this") : null, cljs.core.PersistentVector.fromArray(["trigger", "insert-new-loop"]))
  }]));
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "mouseover", function() {
    return cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "\ufdd0'this")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, "\ufdd0'this");
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "\ufdd0'this")
    }()) ? cljs_jquery.core.dom_create.call(null, "\ufdd0'this") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "\ufdd0'this") : null, cljs.core.PersistentVector.fromArray(["find", ".new-loop-icon"])), cljs.core.PersistentVector.fromArray(["toggleClass", "icon-chevron-right"]))
  ...
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "mouseout", function() {
    return cljs_jquery.core.call_jquery.call(null, cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "\ufdd0'this")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, "\ufdd0'this");
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "\ufdd0'this")
    }()) ? cljs_jquery.core.dom_create.call(null, "\ufdd0'this") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "\ufdd0'this") : null, cljs.core.PersistentVector.fromArray(["find", ".new-loop-icon"])), cljs.core.PersistentVector.fromArray(["toggleClass", "icon-chevron-right"]))
...
session.client.session.new_loop_id = function() {
  return cljs.core.str.call(null, cljs.core.swap_BANG_.call(null, session.client.session.last_loop_id, function(a) {
    return 1 + a
  }))
};
session.client.session.Session = function(a, b, c) {
  this.model = a;
  this.__meta = b;
  this.__extmap = c;
  1 < arguments.length ? (this.__meta = b, this.__extmap = c) : this.__extmap = this.__meta = null
};
session.client.session.Session.prototype.cljs$core$IHash$ = !0;
session.client.session.Session.prototype.cljs$core$IHash$_hash = function(a) {
  return cljs.core.hash_coll.call(null, a)
};
session.client.session.Session.prototype.cljs$core$ILookup$ = !0;
  ...
  return function(a, c, d) {
    switch(arguments.length) {
      case 2:
        return cljs.core._lookup.call(null, a, c, null);
      case 3:
        return cljs.core.truth_("\ufdd0'model" === c) ? this.model : cljs.core.truth_("\ufdd0'else") ? cljs.core.get.call(null, this.__extmap, c, d) : null
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
session.client.session.Session.prototype.cljs$core$IAssociative$ = !0;
session.client.session.Session.prototype.cljs$core$IAssociative$_assoc = function(a, b, c) {
  return cljs.core.truth_(cljs.core.identical_QMARK_.call(null, "\ufdd0'model", b)) ? new session.client.session.Session(c, this.__meta, this.__extmap) : new session.client.session.Session(this.model, this.__meta, cljs.core.assoc.call(null, this.__extmap, b, c))
};
session.client.session.Session.prototype.cljs$core$IRecord$ = !0;
session.client.session.Session.prototype.cljs$core$ICollection$ = !0;
session.client.session.Session.prototype.cljs$core$ICollection$_conj = function(a, b) {
  return cljs.core.truth_(cljs.core.vector_QMARK_.call(null, b)) ? cljs.core._assoc.call(null, a, cljs.core._nth.call(null, b, 0), cljs.core._nth.call(null, b, 1)) : cljs.core.reduce.call(null, cljs.core._conj, a, b)
};
session.client.session.Session.prototype.cljs$core$ISeqable$ = !0;
session.client.session.Session.prototype.cljs$core$ISeqable$_seq = function() {
  return cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'model", this.model)]), this.__extmap))
};
session.client.session.Session.prototype.cljs$core$IPrintable$ = !0;
session.client.session.Session.prototype.cljs$core$IPrintable$_pr_seq = function(a, b) {
  return cljs.core.pr_sequential.call(null, function(a) {
    return cljs.core.pr_sequential.call(null, cljs.core.pr_seq, "", " ", "", b, a)
  }, cljs.core.str.call(null, "#", "session.client.session.Session", "{"), ", ", "}", b, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'model", this.model)]), this.__extmap))
};
session.client.session.Session.prototype.cljs$core$ICounted$ = !0;
session.client.session.Session.prototype.cljs$core$ICounted$_count = function() {
  return 1 + cljs.core.count.call(null, this.__extmap)
};
session.client.session.Session.prototype.cljs$core$IEquiv$ = !0;
session.client.session.Session.prototype.cljs$core$IEquiv$_equiv = function(a, b) {
  var c = a.constructor === b.constructor;
  return cljs.core.truth_(c) ? cljs.core.equiv_map.call(null, a, b) : c
};
session.client.session.Session.prototype.cljs$core$IWithMeta$ = !0;
session.client.session.Session.prototype.cljs$core$IWithMeta$_with_meta = function(a, b) {
  return new session.client.session.Session(this.model, b, this.__extmap)
};
session.client.session.Session.prototype.cljs$core$IMeta$ = !0;
session.client.session.Session.prototype.cljs$core$IMeta$_meta = function() {
  return this.__meta
};
session.client.session.Session.prototype.cljs$core$IMap$ = !0;
session.client.session.Session.prototype.cljs$core$IMap$_dissoc = function(a, b) {
  return cljs.core.truth_(cljs.core.contains_QMARK_.call(null, cljs.core.set(["\ufdd0'model"]), b)) ? cljs.core.dissoc.call(null, cljs.core.with_meta.call(null, cljs.core.into.call(null, cljs.core.ObjMap.fromObject([], {}), a), this.__meta), b) : new session.client.session.Session(this.model, this.__meta, cljs.core.not_empty.call(null, cljs.core.dissoc.call(null, this.__extmap, b)))
};
session.client.session.Session.cljs$core$IPrintable$_pr_seq = function() {
  return cljs.core.list.call(null, "session.client.session.Session")
};
session.client.session.__GT_Session = function(a) {
  return new session.client.session.Session(a)
};
session.client.session.map__GT_Session = function(a) {
  return new session.client.session.Session("\ufdd0'model".call(null, a), null, cljs.core.dissoc.call(null, a, "\ufdd0'model"))
};
session.client.session.Session.prototype.session$client$mvc$IMVC$ = !0;
session.client.session.Session.prototype.session$client$mvc$IMVC$view = function(a) {
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.PersistentVector.fromArray(["\ufdd0'div.session.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span12", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.map.call(null, session.client.mvc.render, "\ufdd0'subsessions".call(null, "\ufdd0'model".call(null, a)))])])]))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var b = cljs.core.vector_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.session.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span12", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.map.call(null, session.client.mvc.render, "\ufdd0'subsessions".call(null, "\ufdd0'model".call(null, a)))])])]));
    return cljs.core.truth_(b) ? b : cljs.core.keyword_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.session.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span12", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.map.call(null, session.client.mvc.render, "\ufdd0'subsessions".call(null, "\ufdd0'model".call(null, a)))])])]))
  }()) ? cljs_jquery.core.dom_create.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.session.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span12", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.map.call(null, session.client.mvc.render, "\ufdd0'subsessions".call(null, "\ufdd0'model".call(null, a)))])])])) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.session.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span12", 
  cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.map.call(null, session.client.mvc.render, "\ufdd0'subsessions".call(null, "\ufdd0'model".call(null, a)))])])])) : null, cljs.core.PersistentVector.fromArray(["data", "model", "\ufdd0'model".call(null, a)]))
};
session.client.session.Session.prototype.session$client$mvc$IMVC$control = function(a) {
  return cljs.core.reset_BANG_.call(null, session.client.session.last_loop_id, "\ufdd0'last-loop-id".call(null, "\ufdd0'model".call(null, a)))
};
session.client.session.Session.prototype.cljs$core$IPrintable$ = !0;
session.client.session.Session.prototype.cljs$core$IPrintable$_pr_seq = function(a, b) {
  return cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray(["#session/session "]), cljs.core._pr_seq.call(null, cljs.core.assoc.call(null, "\ufdd0'model".call(null, a), "\ufdd0'last-loop-id", cljs.core.deref.call(null, session.client.session.last_loop_id)), b), "")
};
session.client.subsession = {};
session.client.subsession.ISubsession = {};
session.client.subsession.insert_new_loop = function(a, b, c) {
  if(cljs.core.truth_(cljs.core.truth_(a) ? a.session$client$subsession$ISubsession$insert_new_loop : a)) {
    a = a.session$client$subsession$ISubsession$insert_new_loop(a, b, c)
  }else {
    var d;
    d = session.client.subsession.insert_new_loop[goog.typeOf.call(null, a)];
    if(!cljs.core.truth_(d) && (d = session.client.subsession.insert_new_loop._, !cljs.core.truth_(d))) {
...
session.client.subsession.delete_loop = function(a, b, c) {
  if(cljs.core.truth_(cljs.core.truth_(a) ? a.session$client$subsession$ISubsession$delete_loop : a)) {
    a = a.session$client$subsession$ISubsession$delete_loop(a, b, c)
  }else {
    var d;
    d = session.client.subsession.delete_loop[goog.typeOf.call(null, a)];
    if(!cljs.core.truth_(d) && (d = session.client.subsession.delete_loop._, !cljs.core.truth_(d))) {
...
session.client.subsession.evaluate_loop = function(a, b, c) {
  if(cljs.core.truth_(cljs.core.truth_(a) ? a.session$client$subsession$ISubsession$evaluate_loop : a)) {
    a = a.session$client$subsession$ISubsession$evaluate_loop(a, b, c)
  }else {
    var d;
    d = session.client.subsession.evaluate_loop[goog.typeOf.call(null, a)];
    if(!cljs.core.truth_(d) && (d = session.client.subsession.evaluate_loop._, !cljs.core.truth_(d))) {
      throw cljs.core.missing_protocol.call(null, "ISubsession.evaluate-loop", a);
    }
    a = d.call(null, a, b, c)
  }
  return a
...
session.client.subsession.evaluate_cljs = function(a) {
  return fetch.remotes.remote_callback.call(null, "compile-expr-string", cljs.core.PersistentVector.fromArray([cljs.core.deref.call(null, "\ufdd0'input".call(null, a))]), function(b) {
    return cljs.core.reset_BANG_.call(null, "\ufdd0'output".call(null, a), function() {
      var a = eval.call(null, "\ufdd0'result".call(null, b));
      return cljs.core.truth_(a) ? a : null
    }())
  })
};
session.client.subsession.Subsession = function(a) {
  this.model = a
};
session.client.subsession.Subsession.cljs$core$IPrintable$_pr_seq = function() {
...
session.client.subsession.Subsession.prototype.session$client$subsession$ISubsession$insert_new_loop = function(a, b, c) {
  var d = c.target, e = cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", d)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, d);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, d)
  }()) ? cljs_jquery.core.dom_create.call(null, d) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, d) : null, cljs.core.PersistentVector.fromArray(["data", "model"])), f = function() {
    var a = session.client.session.new_loop_id.call(null);
    return new session.client.loop.Loop(cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'input", "\ufdd0'output"], {"\ufdd0'id":a, "\ufdd0'input":cljs.core.atom.call(null, ""), "\ufdd0'output":cljs.core.atom.call(null, null)}))
  }(), g = session.client.mvc.render.call(null, f);
  cljs.core.truth_(cljs.core._EQ_.call(null, e, cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]))) ? cljs.core.swap_BANG_.call(null, "\ufdd0'loops".call(null, a), function(a) {
    return cljs.core.vec.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([f]), a))
  }) : cljs.core.swap_BANG_.call(null, "\ufdd0'loops".call(null, a), function(a) {
    var b = cljs.core.split_with.call(null, function(a) {
      return cljs.core.not_EQ_.call(null, a, e)
    }, a), a = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nth.call(null, b, 1, null);
    return cljs.core.vec.call(null, cljs.core.concat.call(null, a, cljs.core.PersistentVector.fromArray([e, f]), cljs.core.rest.call(null, b)))
  });
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", g)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, g);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, g)
  }()) ? cljs_jquery.core.dom_create.call(null, g) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, g) : null, cljs.core.PersistentVector.fromArray(["insertAfter", d]));
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", g)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, g);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, g)
  }()) ? cljs_jquery.core.dom_create.call(null, g) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, g) : null, cljs.core.PersistentVector.fromArray(["trigger", "post-render"]))
};
session.client.subsession.Subsession.prototype.session$client$subsession$ISubsession$delete_loop = function(a, b, c) {
  var d = c.target, e = cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", d)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, d);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, d)
  }()) ? cljs_jquery.core.dom_create.call(null, d) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, d) : null, cljs.core.PersistentVector.fromArray(["data", "model"]));
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", d)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, d);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, d)
  }()) ? cljs_jquery.core.dom_create.call(null, d) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, d) : null, cljs.core.PersistentVector.fromArray(["remove"]));
  return cljs.core.swap_BANG_.call(null, "\ufdd0'loops".call(null, a), function(a) {
    return cljs.core.vec.call(null, cljs.core.filter.call(null, function(a) {
      return cljs.core.not_EQ_.call(null, a, e)
    }, a))
  })
};
session.client.subsession.Subsession.prototype.session$client$subsession$ISubsession$evaluate_loop = function(a, b, c) {
  var d = c.target, b = cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", d)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, d);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, d)
  }()) ? cljs_jquery.core.dom_create.call(null, d) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, d) : null, cljs.core.PersistentVector.fromArray(["data", "model"]));
  return cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'cljs", "\ufdd0'type".call(null, a))) ? session.client.subsession.evaluate_cljs.call(null, b) : cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'clj", "\ufdd0'type".call(null, a))) ? session.client.subsession.evaluate_clj.call(null, b) : null
};
session.client.subsession.Subsession.prototype.session$client$mvc$IMVC$ = !0;
session.client.subsession.Subsession.prototype.session$client$mvc$IMVC$view = function(a) {
  var b = this;
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", cljs.core.PersistentVector.fromArray(["\ufdd0'div.subsession.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span2", cljs.core.PersistentVector.fromArray(["\ufdd0'h3", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'clj", "\ufdd0'type".call(null, a))) ? "Clojure" : "Clojurescript"])])]), function() {
    var a = session.client.mvc.view2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})));
    session.client.mvc.control2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})), a);
    return a
  }(), cljs.core.map.call(null, session.client.mvc.render, cljs.core.deref.call(null, "\ufdd0'loops".call(null, b.model)))]))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var c = cljs.core.vector_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.subsession.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span2", cljs.core.PersistentVector.fromArray(["\ufdd0'h3", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'clj", "\ufdd0'type".call(null, a))) ? "Clojure" : "Clojurescript"])])]), function() {
      var a = session.client.mvc.view2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})));
      session.client.mvc.control2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})), a);
      return a
    }(), cljs.core.map.call(null, session.client.mvc.render, cljs.core.deref.call(null, "\ufdd0'loops".call(null, b.model)))]));
    return cljs.core.truth_(c) ? c : cljs.core.keyword_QMARK_.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.subsession.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span2", cljs.core.PersistentVector.fromArray(["\ufdd0'h3", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'clj", "\ufdd0'type".call(null, a))) ? "Clojure" : "Clojurescript"])])]), function() {
      var a = session.client.mvc.view2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})));
      session.client.mvc.control2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})), a);
      return a
    ...
    session.client.mvc.control2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})), a);
    return a
  }(), cljs.core.map.call(null, session.client.mvc.render, cljs.core.deref.call(null, "\ufdd0'loops".call(null, b.model)))])) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div.subsession.span6", cljs.core.PersistentVector.fromArray(["\ufdd0'div.row", cljs.core.PersistentVector.fromArray(["\ufdd0'div.span2", cljs.core.PersistentVector.fromArray(["\ufdd0'h3", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'clj", "\ufdd0'type".call(null, 
  a))) ? "Clojure" : "Clojurescript"])])]), function() {
    var a = session.client.mvc.view2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})));
    session.client.mvc.control2.call(null, cljs.core.with_meta(cljs.core.PersistentVector.fromArray(["\ufdd0'loop-creator"]), cljs.core.ObjMap.fromObject(["\ufdd0'view"], {"\ufdd0'view":"\ufdd0'loop-creator"})), a);
    return a
  }(), cljs.core.map.call(null, session.client.mvc.render, cljs.core.deref.call(null, "\ufdd0'loops".call(null, b.model)))])) : null, cljs.core.PersistentVector.fromArray(["data", "model", b.model]))
};
session.client.subsession.Subsession.prototype.session$client$mvc$IMVC$control = function(a, b) {
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "insert-new-loop", function(c) {
    return session.client.subsession.insert_new_loop.call(null, a, b, c)
  }]));
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "delete-loop", function(c) {
    return session.client.subsession.delete_loop.call(null, a, b, c)
  }]));
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", b)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, b)
  }()) ? cljs_jquery.core.dom_create.call(null, b) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, b) : null, cljs.core.PersistentVector.fromArray(["on", "evaluate-loop", function(c) {
    return session.client.subsession.evaluate_loop.call(null, a, b, c)
  }]))
};
session.client.subsession.Subsession.prototype.cljs$core$IPrintable$ = !0;
session.client.subsession.Subsession.prototype.cljs$core$IPrintable$_pr_seq = function(a, b) {
  return cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray(["#session/subsession "]), cljs.core._pr_seq.call(null, cljs.core.assoc.call(null, this.model, "\ufdd0'loops", cljs.core.deref.call(null, "\ufdd0'loops".call(null, this.model))), b), "")
};
session.client.subsession.Subsession.prototype.cljs$core$ILookup$ = !0;
...
c2.maths.extent = function(a) {
  return cljs.core.PersistentVector.fromArray([cljs.core.apply.call(null, cljs.core.min, a), cljs.core.apply.call(null, cljs.core.max, a)])
};
...
c2.svg = {};
c2.svg.translate = function(a) {
  for(;;) {
    if(cljs.core.truth_(cljs.core.vector_QMARK_.call(null, a))) {
      if(cljs.core.truth_(function() {
        var b = cljs.core.vector_QMARK_.call(null, a);
        return cljs.core.truth_(b) ? cljs.core._EQ_.call(null, cljs.core.count.call(null, a), 2) : b
      }())) {
        var b = cljs.core.nth.call(null, a, 0), c = cljs.core.nth.call(null, a, 1);
        return cljs.core.str.call(null, "translate(", b, ",", c, ")")
      }
      if(cljs.core.truth_("\ufdd0'else")) {
    ...
    if(cljs.core.truth_(function() {
      ...
      return cljs.core.truth_(function() {
        if(cljs.core.truth_(b)) {
          var a = b.cljs$core$ILookup$;
          return cljs.core.truth_(a) ? cljs.core.not.call(null, b.hasOwnProperty("cljs$core$ILookup$")) : a
        }
        return b
      }()) ? !0 : cljs.core.type_satisfies_.call(null, cljs.core.ILookup, b)
    }())) {
      b = cljs.core.get.call(null, a, "\ufdd0'y"), c = cljs.core.get.call(null, a, "\ufdd0'x"), a = cljs.core.PersistentVector.fromArray([c, b])
    }else {
      return cljs.core.truth_("\ufdd0'else"), null
    }
  }
};
c2.svg.scale = function(a) {
  for(;;) {
    if(cljs.core.truth_(cljs.core.vector_QMARK_.call(null, a))) {
      if(cljs.core.truth_(function() {
        var b = cljs.core.vector_QMARK_.call(null, a);
        ...
        var b = cljs.core.nth.call(null, a, 0), c = cljs.core.nth.call(null, a, 1);
        return cljs.core.str.call(null, "scale(", b, ",", c, ")")
      }
      if(cljs.core.truth_("\ufdd0'else")) {
        throw new java.lang.Exception(cljs.core.str.call(null, "No match found. ", "Followed ", 1, " branches.", " Breadcrumbs: ", cljs.core.vec([cljs.core.list("\ufdd1'clojure.core/vector?", "\ufdd1'coordinates")])));
      }
...
c2.svg.axis = function() {
  var a = function(a, b, e) {
    var e = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, e)) ? cljs.core.apply.call(null, cljs.core.hash_map, e) : e, f = cljs.core.get.call(null, e, "\ufdd0'text-margin", 9), g = cljs.core.get.call(null, e, "\ufdd0'major-tick-width", 6), h = cljs.core.get.call(null, e, "\ufdd0'formatter", cljs.core.str), e = cljs.core.get.call(null, e, "\ufdd0'orientation", "\ufdd0'left"), i = c2.svg.case$.call(null, e, "\ufdd0'left".call(null, "\ufdd0'right"), cljs.core.PersistentVector.fromArray("\ufdd0'x,\ufdd0'y,\ufdd0'x1,\ufdd0'x2,\ufdd0'y1,\ufdd0'y2".split(",")), 
    "\ufdd0'top".call(null, "\ufdd0'bottom"), cljs.core.PersistentVector.fromArray("\ufdd0'y,\ufdd0'x,\ufdd0'y1,\ufdd0'y2,\ufdd0'x1,\ufdd0'x2".split(","))), j = cljs.core.nth.call(null, i, 0, null), k = cljs.core.nth.call(null, i, 1, null), m = cljs.core.nth.call(null, i, 2, null), l = cljs.core.nth.call(null, i, 3, null), o = cljs.core.nth.call(null, i, 4, null), i = cljs.core.nth.call(null, i, 5, null), n = c2.svg.case$.call(null, e, "\ufdd0'left".call(null, "\ufdd0'top"), -1, "\ufdd0'right".call(null, 
    "\ufdd0'bottom"), 1);
    return cljs.core.PersistentVector.fromArray(["\ufdd0'g.axis", cljs.core.ObjMap.fromObject(["\ufdd0'class"], {"\ufdd0'class":cljs.core.name.call(null, e)}), cljs.core.PersistentVector.fromArray(["\ufdd0'line.rule", cljs.core.apply.call(null, cljs.core.hash_map, cljs.core.interleave.call(null, cljs.core.PersistentVector.fromArray([o, i]), "\ufdd0'range".call(null, a)))]), cljs.core.map.call(null, function(b) {
      return cljs.core.PersistentVector.fromArray(["\ufdd0'g.major-tick", cljs.core.ObjMap.fromObject(["\ufdd0'transform"], {"\ufdd0'transform":c2.svg.translate.call(null, cljs.core.HashMap.fromArrays([j, k], [0, a.call(null, b)]))}), cljs.core.PersistentVector.fromArray(["\ufdd0'text", cljs.core.HashMap.fromArrays([j], [n * f]), h.call(null, b)]), cljs.core.PersistentVector.fromArray(["\ufdd0'line", cljs.core.HashMap.fromArrays([m, l], [0, n * g])])])
    }, b)])
  }, b = function(b, d, e) {
    var f = null;
    goog.isDef(e) && (f = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0));
...
c2.svg.circle = function() {
  ...
  return a = function(b, c) {
    switch(arguments.length) {
      case 1:
        return a.call(null, cljs.core.PersistentVector.fromArray([0, 0]), b);
      case 2:
        var d = cljs.core.nth.call(null, b, 0, null), e = cljs.core.nth.call(null, b, 1, null);
        return cljs.core.str.call(null, "M", d + c, ",", e, "A", d + c, ",", e + c, " 0 1,1", -(d + c), ",", e, "A", d + c, ",", e + c, " 0 1,1", d + c, ",", e)
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
c2.svg.arc = function() {
  var a = function(a) {
    var b = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, e = cljs.core.get.call(null, b, "\ufdd0'angle-offset", 0), f = cljs.core.get.call(null, b, "\ufdd0'end-angle", c2.maths.Pi), g = cljs.core.get.call(null, b, "\ufdd0'start-angle", 0), a = cljs.core.get.call(null, b, "\ufdd0'outer-radius", 1), b = cljs.core.get.call(null, b, "\ufdd0'inner-radius", 0), e = cljs.core.sort.call(null, cljs.core.PersistentVector.fromArray([e + g, e + 
    f])), h = cljs.core.nth.call(null, e, 0, null), i = cljs.core.nth.call(null, e, 1, null), e = i - h, f = cljs.core.truth_(e < c2.maths.Pi) ? "0" : "1", g = c2.maths.sin.call(null, h), h = c2.maths.cos.call(null, h), j = c2.maths.sin.call(null, i), i = c2.maths.cos.call(null, i);
    return cljs.core.truth_(e >= c2.svg.ArcMax) ? cljs.core.str.call(null, "M0,", a, "A", a, ",", a, " 0 1,1 0,", -a, "A", a, ",", a, " 0 1,1 0,", a, cljs.core.truth_(cljs.core.not_EQ_.call(null, 0, b)) ? cljs.core.str.call(null, "M0,", b, "A", b, ",", b, " 0 1,0 0,", -b, "A", b, ",", b, " 0 1,0 0,", b) : null, "Z") : cljs.core.str.call(null, "M", a * h, ",", a * g, "A", a, ",", a, " 0 ", f, ",1 ", a * i, ",", a * j, cljs.core.truth_(cljs.core.not_EQ_.call(null, 0, b)) ? cljs.core.str.call(null, 
    "L", b * i, ",", b * j, "A", b, ",", b, " 0 ", f, ",0 ", b * h, ",", b * g) : "L0,0", "Z")
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
c2.layout.partition.partition = function() {
  var a = function(a, b) {
    var e = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, b)) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, f = cljs.core.get.call(null, e, "\ufdd0'output-key", "\ufdd0'partition"), g = cljs.core.get.call(null, e, "\ufdd0'size", cljs.core.PersistentVector.fromArray([1, 1])), h = cljs.core.get.call(null, e, "\ufdd0'value", "\ufdd0'value"), i = cljs.core.get.call(null, e, "\ufdd0'children", "\ufdd0'children");
    cljs.core.get.call(null, e, "\ufdd0'sort", null);
    c2.layout.partition.depth = function k(a) {
      a = i.call(null, a);
      a = cljs.core.truth_(a) ? cljs.core.apply.call(null, cljs.core.max, cljs.core.map.call(null, k, a)) : 0;
      return a + 1
    };
    c2.layout.partition.node_value = function m(a) {
      var b = i.call(null, a);
      return cljs.core.truth_(b) ? cljs.core.apply.call(null, cljs.core._PLUS_, cljs.core.map.call(null, m, b)) : h.call(null, a)
    };
    c2.layout.partition.position = function l(a, b, c, d) {
      var e = cljs.core.nth.call(null, d, 0, null), g = cljs.core.nth.call(null, d, 1, null);
      return cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.assoc.call(null, a, f, cljs.core.merge.call(null, f.call(null, a), cljs.core.ObjMap.fromObject("\ufdd0'depth,\ufdd0'value,\ufdd0'x,\ufdd0'y,\ufdd0'dx,\ufdd0'dy".split(","), {"\ufdd0'depth":b, "\ufdd0'value":c2.layout.partition.node_value.call(null, a), "\ufdd0'x":c, "\ufdd0'y":b * g, "\ufdd0'dx":e, "\ufdd0'dy":g})))]), function() {
        var d = e / c2.layout.partition.node_value.call(null, a), f = i.call(null, a);
        return cljs.core.flatten.call(null, cljs.core.map.call(null, function(a, c) {
          return l.call(null, a, b + 1, c, cljs.core.PersistentVector.fromArray([d * c2.layout.partition.node_value.call(null, a), g]))
        }, f, cljs.core.reductions.call(null, function(a, b) {
          return a + d * c2.layout.partition.node_value.call(null, b)
        }, c, f)))
      }())
    };
    return c2.layout.partition.position.call(null, a, 0, 0, cljs.core.PersistentVector.fromArray([cljs.core.first.call(null, g), cljs.core.second.call(null, g) / c2.layout.partition.depth.call(null, a)]))
  }, b = function(b, d) {
    var e = null;
    goog.isDef(d) && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
    return a.call(this, b, e)
...
session.client.svgtest = {};
session.client.svgtest.unify = function() {
  var a = null;
  return a = function(b, c, d) {
    switch(arguments.length) {
      case 2:
        return cljs.core.map.call(null, c, b);
      case 3:
        return cljs.core.into.call(null, b, a.call(null, c, d))
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
session.client.svgtest.style = function() {
  var a = function(a, b) {
    var e = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, b)) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, f = cljs.core.get.call(null, e, "\ufdd0'numeric-suffix", "px");
        ...
        return new cljs.core.LazySeq(null, !1, function() {
          for(;;) {
            if(cljs.core.truth_(cljs.core.seq.call(null, a))) {
              ...
              return cljs.core.cons.call(null, cljs.core.str.call(null, cljs.core.name.call(null, c), ":", cljs.core.truth_(cljs.core.number_QMARK_.call(null, b)) ? cljs.core.str.call(null, b, f) : b, ";"), h.call(null, cljs.core.rest.call(null, a)))
            }
            return null
          }
        })
...
session.client.svgtest.result = function() {
  var a = cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'children"], {"\ufdd0'name":"Delicious Pie", "\ufdd0'children":cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'bites"], {"\ufdd0'name":"Eaten", "\ufdd0'bites":11}), cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'bites"], {"\ufdd0'name":"Not Eaten", "\ufdd0'bites":39}), cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'bites"], {"\ufdd0'name":"Silverware", "\ufdd0'bites":8})])}), a = cljs.core.filter.call(null, 
  function(a) {
    return cljs.core._EQ_.call(null, "\ufdd0'depth".call(null, "\ufdd0'partition".call(null, a)), 1)
  }, c2.layout.partition.partition.call(null, a, "\ufdd0'value", "\ufdd0'bites", "\ufdd0'size", cljs.core.PersistentVector.fromArray([c2.maths.Tau, 1])));
  return cljs.core.PersistentVector.fromArray(["\ufdd0'svg", cljs.core.PersistentVector.fromArray(["\ufdd0'g", cljs.core.ObjMap.fromObject(["\ufdd0'transform"], {"\ufdd0'transform":"translate(200,200)"}), session.client.svgtest.unify.call(null, a, function(a) {
    var a = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core.get.call(null, a, "\ufdd0'name");
    cljs.core.get.call(null, a, "\ufdd0'bites");
    var a = cljs.core.get.call(null, a, "\ufdd0'partition"), a = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core.get.call(null, a, "\ufdd0'dx"), e = cljs.core.get.call(null, a, "\ufdd0'x");
    return cljs.core.PersistentVector.fromArray(["\ufdd0'g.slice", cljs.core.PersistentVector.fromArray(["\ufdd0'path", cljs.core.ObjMap.fromObject(["\ufdd0'd", "\ufdd0'style"], {"\ufdd0'd":c2.svg.arc.call(null, "\ufdd0'outer-radius", 170, "\ufdd0'start-angle", e, "\ufdd0'end-angle", e + d), "\ufdd0'style":session.client.svgtest.style.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'stroke", "\ufdd0'fill"], {"\ufdd0'stroke":"black", "\ufdd0'fill":session.client.svgtest.case$.call(null, c, "Eaten", 
    "yellow", "Not Eaten", "tan", "Silverware", "silver")}))})]), function() {
      var a = e + d / 2;
      return cljs.core.PersistentVector.fromArray(["\ufdd0'text", cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y", "\ufdd0'text-anchor"], {"\ufdd0'x":85 * c2.maths.cos.call(null, a), "\ufdd0'y":85 * c2.maths.sin.call(null, a), "\ufdd0'text-anchor":function() {
        var b = cljs.core._GT_, c = a % c2.maths.Tau;
        if(cljs.core.truth_(b.call(null, 0.25 * c2.maths.Tau, c))) {
          return"start"
        }
        if(cljs.core.truth_(b.call(null, 0.75 * c2.maths.Tau, c))) {
          return"end"
        }
        if(cljs.core.truth_(b.call(null, c2.maths.Tau, c))) {
          return"start"
        }
        throw Error(cljs.core.str.call(null, "No matching clause: ", c));
      }()}), cljs.core.str.call(null, c)])
    }()])
  })])])
}();
...
cljs_jquery.core.dom_append = function dom_append(b, c) {
  return cljs.core.truth_(cljs.core.seq_QMARK_.call(null, c)) ? cljs.core.dorun.call(null, cljs.core.map.call(null, function(c) {
...
cljs_jquery.core.set_dom_attribute = function(a, b) {
  ...
  return cljs.core.truth_(cljs.core.string_QMARK_.call(null, d)) ? a.attr(cljs.core.name.call(null, c), d) : cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'css", c)) ? cljs.core.dorun.call(null, cljs.core.map.call(null, function(b) {
...
cljs_jquery.core.keyword_to_dom_object = function(a) {
  ...
  d = cljs.core.truth_(d) ? cljs.core.PersistentVector.fromArray([cljs.core.truth_(e) ? e : c, d]) : cljs.core.PersistentVector.fromArray(["\ufdd0'xhtml".call(null, cljs_jquery.core.xmlns), c]);
  c = cljs.core.nth.call(null, d, 0, null);
  d = cljs.core.nth.call(null, d, 1, null);
...
cljs_jquery.core.hiccup_to_dom_object = function(a) {
  ...
  cljs.core.truth_(cljs.core.map_QMARK_.call(null, cljs.core.first.call(null, a))) ? (cljs.core.dorun.call(null, cljs.core.map.call(null, function(a) {
...
cljs_jquery.core.dom_create = function dom_create(b) {
  return cljs.core.truth_(cljs_jquery.core.dom_element_QMARK_.call(null, b)) ? cljs_jquery.core.jquery.call(null, b) : cljs.core.truth_(cljs_jquery.core.jquery_dom_element_QMARK_.call(null, b)) ? b : cljs.core.truth_(cljs.core.keyword_QMARK_.call(null, b)) ? cljs_jquery.core.keyword_to_dom_object.call(null, b) : cljs.core.truth_(cljs.core.string_QMARK_.call(null, b)) ? cljs_jquery.core.jquery.call(null, document.createTextNode(b)) : cljs.core.truth_(function() {
    var c = cljs.core.vector_QMARK_.call(null, b);
    return cljs.core.truth_(c) ? cljs.core.first.call(null, b) : c
  }()) ? cljs_jquery.core.hiccup_to_dom_object.call(null, b) : cljs.core.truth_(cljs.core.seq_QMARK_.call(null, b)) ? cljs.core.map.call(null, dom_create, b) : null
};
...
cljs_jquery.core.call_jquery = function(a, b) {
  ...
  if(cljs.core.truth_(function() {
    var a = cljs.core.not.call(null, cljs.core.empty_QMARK_.call(null, d));
    return cljs.core.truth_(a) ? cljs.core.map_QMARK_.call(null, cljs.core.nth.call(null, d, 0)) : a
  }())) {
  ...
  throw Error(cljs.core.str.call(null, "No matching clause: ", g));
};
clojure.browser = {};
...
session.client.main.load_session = function(a) {
  return fetch.remotes.remote_callback.call(null, "get-session", cljs.core.PersistentVector.fromArray([a]), function(a) {
    var c = eval.call(null, "\ufdd0'result".call(null, a)), d = cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", session.client.mvc.view.call(null, c))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, session.client.mvc.view.call(null, c));
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, session.client.mvc.view.call(null, c))
    }()) ? cljs_jquery.core.dom_create.call(null, session.client.mvc.view.call(null, c)) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, session.client.mvc.view.call(null, c)) : null;
    cljs.core.reset_BANG_.call(null, session.client.main.session, c);
    session.client.mvc.control.call(null, c, d);
    cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "body > .container")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, "body > .container");
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "body > .container")
    }()) ? cljs_jquery.core.dom_create.call(null, "body > .container") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "body > .container") : null, cljs.core.PersistentVector.fromArray(["html", ""]));
    cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", d)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, d);
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, d)
    }()) ? cljs_jquery.core.dom_create.call(null, d) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, d) : null, cljs.core.PersistentVector.fromArray(["appendTo", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "body > .container")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, "body > .container");
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "body > .container")
    }()) ? cljs_jquery.core.dom_create.call(null, "body > .container") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "body > .container") : null]));
    return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", ".loop-container")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
      var a = cljs.core.vector_QMARK_.call(null, ".loop-container");
      return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, ".loop-container")
    }()) ? cljs_jquery.core.dom_create.call(null, ".loop-container") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, ".loop-container") : null, cljs.core.PersistentVector.fromArray(["trigger", "post-render"]))
  })
};
session.client.main.save_session = function() {
  return fetch.remotes.remote_callback.call(null, "store-session", cljs.core.PersistentVector.fromArray(["\ufdd0'id".call(null, cljs.core.deref.call(null, session.client.main.session)), cljs.core.pr_str.call(null, cljs.core.deref.call(null, session.client.main.session))]), function(a) {
    return a
  })
};
session.client.main.load_new_file = function(a) {
  var b = eval.call(null, a), c = cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", session.client.mvc.view.call(null, b))) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, session.client.mvc.view.call(null, b));
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, session.client.mvc.view.call(null, b))
  }()) ? cljs_jquery.core.dom_create.call(null, session.client.mvc.view.call(null, b)) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, session.client.mvc.view.call(null, b)) : null;
  cljs.core.reset_BANG_.call(null, session.client.main.session, b);
  session.client.mvc.control.call(null, b, c);
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "body > .container")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, "body > .container");
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "body > .container")
  }()) ? cljs_jquery.core.dom_create.call(null, "body > .container") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "body > .container") : null, cljs.core.PersistentVector.fromArray(["html", ""]));
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", c)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, c);
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, c)
  }()) ? cljs_jquery.core.dom_create.call(null, c) : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, c) : null, cljs.core.PersistentVector.fromArray(["appendTo", cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "body > .container")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, "body > .container");
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "body > .container")
  }()) ? cljs_jquery.core.dom_create.call(null, "body > .container") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "body > .container") : null]));
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", ".loop-container")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
...
session.client.main.download_session = function() {
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "#downloadformdata")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, "#downloadformdata");
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "#downloadformdata")
  }()) ? cljs_jquery.core.dom_create.call(null, "#downloadformdata") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "#downloadformdata") : null, cljs.core.PersistentVector.fromArray(["val", function() {
    var a = cljs.core._STAR_print_meta_STAR_;
    try {
      return cljs.core._STAR_print_meta_STAR_ = !0, cljs.core.pr_str.call(null, cljs.core.deref.call(null, session.client.main.session))
    }finally {
      cljs.core._STAR_print_meta_STAR_ = a
    }
  }()]));
  return cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "#downloadform")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, "#downloadform");
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "#downloadform")
  }()) ? cljs_jquery.core.dom_create.call(null, "#downloadform") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "#downloadform") : null, cljs.core.PersistentVector.fromArray(["submit"]))
};
session.client.main.ds2 = function() {
  var a = cljs.core.str.call(null, "data:text/csv;charset=UTF-8,", encodeURIComponent.call(null, function() {
    var a = cljs.core._STAR_print_meta_STAR_;
    try {
      return cljs.core._STAR_print_meta_STAR_ = !0, cljs.core.pr_str.call(null, cljs.core.deref.call(null, session.client.main.session))
    }finally {
...
cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", document)) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
  ...
  }()) ? cljs_jquery.core.dom_create.call(null, "#savebutton") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "#savebutton") : null, cljs.core.PersistentVector.fromArray(["on", "click", function() {
    return session.client.main.download_session.call(null)
  }]));
  session.client.editor.add_keybindings.call(null);
  cljs_jquery.core.call_jquery.call(null, cljs.core.truth_(cljs.core._EQ_.call(null, "\ufdd0'this", "#fileupload")) ? cljs_jquery.core.jquery.call(null, this) : cljs.core.truth_(function() {
    var a = cljs.core.vector_QMARK_.call(null, "#fileupload");
    return cljs.core.truth_(a) ? a : cljs.core.keyword_QMARK_.call(null, "#fileupload")
  }()) ? cljs_jquery.core.dom_create.call(null, "#fileupload") : cljs.core.truth_(!0) ? cljs_jquery.core.jquery.call(null, "#fileupload") : null, cljs.core.PersistentVector.fromArray(["fileupload", goog.object.create.call(null, "add", function(a, b) {
    return b.submit().complete(function(a) {
      return session.client.main.load_new_file.call(null, a.responseText)
    })
  })]));
